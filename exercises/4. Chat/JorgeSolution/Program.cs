...
// var responseStream = chatClient.GetStreamingResponseAsync("Explain how real AI compares to sci-fi AI in max 500 words.");
...
foreach (var listingText in propertyListings.Take(2))
{
