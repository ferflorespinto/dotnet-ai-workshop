...
public partial class Quiz : ComponentBase
{
    ...
    private async Task SubmitAnswerAsync()
    {
        ...
        currentQuestionOutcome = quizAnswerDetails.MarkingResponse.Feedback;
        bool isAnswerCorrect = quizAnswerDetails.MarkingResponse.IsStudentAnswerCorrect;
...
class QuizAnswerDetails
{
    ...
    public required MarkingResponse MarkingResponse { get; set; }
}

enum ResponseClassfication { CORRECT, INCORRECT }
class MarkingResponse
{
    public required string Feedback { get; set; }
    public bool IsStudentAnswerCorrect { get; set; }
    //public required ResponseClassfication IsStudentAnswerCorrect { get; set; }
}
